...
cd $BUILD_DIR
cmake3 -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED_LIBS=0 -DCPP-NETLIB_BUILD_TESTS=OFF -DCPP-NETLIB_BUILD_EXAMPLES=OFF -DUri_BUILD_TESTS=OFF -DUri_BUILD_DOCS=OFF \
