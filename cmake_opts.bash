...
opts+=("-DJSON_BIN_DIR=$top_dir/ext/prefix_$PREFIX/bin")
opts+=("-DJSON_INCLUDE_DIR=$top_dir/ext/prefix_$PREFIX/include")
opts+=("-DJSON_LIB_DIR=$top_dir/ext/prefix_$PREFIX/lib")
opts+=("-DCPP_NETLIB_INCLUDE_DIR=$top_dir/ext/prefix_linux-64x/include")
opts+=("-DCPP_NETLIB_LIB_DIR=$top_dir/ext/prefix_linux-64x/lib")
